...
""").write.mode('overwrite').option("path","s3://aws-a0095-use1-00-d-s3b-shrd-shr-input01/Output_Files/RX/"+CURR_TA_S+"/p04_claims_splitting").saveAsTable("hes_stencil.P04_RX_HUM_REP_CHILD_PLAN_DRUG")
...
spark.sql("""SELECT
	...
	FINAL_CHILD,CHILD_COT_TYPE,ADDRESS,CITY,STATE,ZIP_CODE,LHM_ID,LHM_NAME,CBSA,CBSA_NAME,CBSA_TYPE,
	ENTITY_ID,ENTITY_NAME,AHRQ_FLAG,ENTITY_FIRM_TYPE,FINAL_ENTITY_TYPE,REFINED_ENTITY_TYPE,IDN_INTEGRATION_LEVEL,
	sum(CLAIM_COUNT) CLAIM_COUNT, sum(PATIENT_PAY_NORM) PATIENT_PAY_NORM,sum(PLAN_PAY_NORM) PLAN_PAY_NORM from hes_stencil.P04_RX_HUM_REP_CHILD_PLAN_DRUG
	...
	FINAL_CHILD,CHILD_COT_TYPE,ADDRESS,CITY,STATE,ZIP_CODE,LHM_ID,LHM_NAME,CBSA,CBSA_NAME,CBSA_TYPE,
	ENTITY_ID,ENTITY_NAME,AHRQ_FLAG,ENTITY_FIRM_TYPE,FINAL_ENTITY_TYPE,REFINED_ENTITY_TYPE,IDN_INTEGRATION_LEVEL
""").write.mode('overwrite').option("path","s3://aws-a0095-use1-00-d-s3b-shrd-shr-input01/Output_Files/RX/"+CURR_TA_S+"/p04_RX_DIABATES_CHILD_PLAN_DRUG_2019").saveAsTable("hes_stencil.P04_RX_HUM_REP_CHILD_PLAN_DRUG_2019")
